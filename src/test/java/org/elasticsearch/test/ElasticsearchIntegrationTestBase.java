...
/**
 * {@link ElasticsearchIntegrationTestBase} is an abstract base class to run integration
 ...
 * <pre>
 *
 * @ClusterScope(scope=Scope.TEST) public class SomeIntegrationTest extends ElasticsearchIntegrationTestBase {
 ...
 * public class SomeIntegrationTest extends ElasticsearchIntegrationTestBase {
 * @Test public void testMethod() {}
 * }
 * </pre>
 * <p/>
 * Note, the {@link ElasticsearchIntegrationTestBase} uses randomized settings on a cluster and index level. For instance
...
public abstract class ElasticsearchIntegrationTestBase extends ElasticsearchTestCase {
     ...
     * {@link org.elasticsearch.test.ElasticsearchIntegrationTest.ClusterScope} annotations on {@link org.elasticsearch.test.ElasticsearchIntegrationTestBase} subclasses.
     */
    ...
    /**
     * Defines a cluster scope for a {@link org.elasticsearch.test.ElasticsearchIntegrationTestBase} subclass.
     * By default if no {@link ClusterScope} annotation is present {@link org.elasticsearch.test.ElasticsearchIntegrationTestBase.Scope#GLOBAL} is used
    ...
    public @interface ClusterScope {
        /**
         * Returns the scope. {@link org.elasticsearch.test.ElasticsearchIntegrationTestBase.Scope#GLOBAL} is default.
         */
    ...
    private ClusterScope getAnnotation(Class<?> clazz) {
        if (clazz == Object.class || clazz == ElasticsearchIntegrationTestBase.class) {
            return null;
        }
